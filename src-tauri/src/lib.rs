...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::position_snapshots::save_position_snapshot,
            ...
            commands::transactions::ignore_duplicate_transaction,
            commands::transactions::audit_duplicate_transactions,
            commands::transactions::dismiss_duplicate_candidate_group,
